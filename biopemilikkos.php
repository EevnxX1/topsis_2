                                    ...
                                    <?php } else { ?>
                                        ...
                                        <form action="" class="form-horizontal" data-toggle="validator" role="form" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" data-error="Nama Kos Tidak Boleh Kosong." id="namakos" placeholder="Nama Universitas" name="namakos" type="text" required />
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="alamat">Alamat Universitas</label>
                                                <textarea class="form-control" data-error="Alamat Tidak Boleh Kosong." id="alamat" name="alamat" rows="5" cols="50" placeholder="Alamat Universitas" required></textarea>
                                                <div class="help-block with-errors"></div>
                                            </div>

                                            <div class="form-group">
                                                <input id="btn-fblogin" class="btn btn-danger" type="submit" value="Input Data Univ" />
                                            </div>
                                        </form>
                                    <?php } ?>
                                </div>
