...
(13, 21, 'S1', 'UCIC', '3500000', 'PTN', 'LOMBA POSTER (1).png', 'Logo Himatif.png', 'web design.png', 'globall (5).png', 'y');
...
(2, 'cost', '4', 'Biaya'),
(3, 'benefit', '3', 'Akreditasi Univ'),
(4, 'benefit', '3', 'Akreditasi Jurusan'),
(5, 'cost', '2', 'Jarak');
...
('anwar', 'Anwar', 'jl.apa saja', '0843423424', 'apasaja@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '', 'user'),
('mifta', 'Miftahul huda', 'jl. pancuran', '082342342125', 'jokowiyntkts38@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '', 'pemilik');
...
(1, '', 'Yuliantati', 'Universitas Gunung jati (UGJ)', '085291162992', ' Jl. Pemuda Raya No.32, Sunyaragi, Kec. Kesambi', '', 'y'),
(2, '', 'Pak Elvis', 'Universitas Muhammadiyah Cirebon', '08156972222', 'Jl. Tuparev No.70, Kedungjaya, Kec. Kedawung, Kabupaten Cirebon', '', 'y'),
(3, '', 'Rizka Dwi Ananda', '(IAIN) Syekh Nurjati', '081327085692', 'Jl. Perjuangan, Sunyaragi, Kec. Kesambi, Kota Cirebon, Jawa Barat', '', 'y'),
(4, '', 'Hj. Siti Sopiyah', 'Universitas 17 Agustus 1945 Cirebon (UNTAG) ', '081327085692', 'Jl. Perjuangan No.17, Karyamulya, Kec. Kesambi, Kota Cirebon', '', 'y'),
(5, '', 'Ibu Tia', 'Universitas Insan Cendekia Cirebon', '08242759755', 'Jl. Kesambi No.202, Drajat, Kec. Kesambi, Kota Cirebon', '', 'y'),
(8, '', 'Bapak Fajar', ' (STMIK) IKMI Cirebon ', '085726847653', 'Jl. Perjuangan No.10B, Karyamulya, Kec. Kesambi, Kota Cirebon', '', 'y'),
(9, '', 'Ibu Ana', '(UNU) Cirebon', '08164880053', 'Jl. Sisingamangaraja No.33, Panjunan, Kec. Lemahwungkuk, Kota Cirebon', '', 'y'),
(10, '', 'Bapak Kirman', 'Sekolah Tinggi Teknologi Cirebon', '085726063530', 'Jl. Evakuasi No.11, Karyamulya, Kec. Kesambi, Kota Cirebon', '', 'y'),
(11, '', 'Ahmad Djaelani', 'STIKES Mahardika Cirebon', '083845046050', 'Jl. Terusan Sekar Kemuning No.199, Karyamulya, Kec. Kesambi, Kota Cirebon', '', 'y'),
(12, '', 'Bapak Yusman', 'STIKES Cirebon', '028161392418', 'Jl. Brigjend Dharsono No.12b, Kertawinangun, Kec. Kedawung, Kabupaten Cirebon', '', 'y');
...
(1, 1, 'perpustakaan', '1'),
(2, 1, 'perpustakaan, laboratorium', '2'),
(3, 1, 'perpustakaan, laboratorium, laboratorium komputer,', '3'),
(4, 1, 'perpustakaan, laboratorium, laboratorium komputer, wifi zone', '4'),
(5, 1, 'perpustakaan, laboratorium, laboratorium komputer, wifi zone, taman diskusi mahasiswa', '5'),
(6, 2, '>=5000000', '1'),
(7, 2, '>5000000<3000000', '2'),
(8, 2, '>3000000<2500000', '3'),
(9, 2, '>2500000<2000000', '4'),
(10, 2, '<=2000000', '5'),
(11, 3, 'Belum Terakreditasi', '1'),
(12, 3, 'Proses Akreditasi', '2'),
(13, 3, 'C (Baik)', '3'),
(14, 3, 'B (Baik Sekali)', '4'),
(15, 3, 'A (Unggul)', '5'),
(16, 4, 'Belum Terakreditasi', '1'),
(17, 4, 'Proses Akreditasi', '2'),
(18, 4, 'C (Baik)', '3'),
(19, 4, 'B (Baik Sekali)', '4'),
(20, 4, 'A (Unggul)', '5'),
(21, 5, '>=1KM', '1'),
(22, 5, '>1KM<500M', '2'),
(23, 5, '>500M<250M', '3'),
...
--
ALTER TABLE `pemilik`
  MODIFY `id_pemilik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
