        ...
        <nav class="sidebar-nav">
            ...
            <?php elseif ($_SESSION['status'] == 'pemilik'): ?>
                <ul id="sidebarnav">
                    ...
                    <li><a class="waves-effect waves-dark" href="inputkamarpemilik.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Input Jurusan</span></a></li>
                    <li><a class="waves-effect waves-dark" href="listkamarpemilik.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Daftar Jurusan</span></a></li>
                    <li><a class="waves-effect waves-dark" href="logout.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Logout</span></a></li>
                </ul>
